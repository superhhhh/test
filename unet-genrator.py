...
class myUnet(object):
	# 参数初始化定义
	def __init__(self, img_rows=256, img_cols=2112):
	...
	def train(self):
		...
		print('Fitting model...')
		#model.fit(imgs_train, imgs_mask_train, batch_size=1, nb_epoch=50, verbose=1,validation_split=0.2, shuffle=True, callbacks=[model_checkpoint])
		model.fit_generator(data_generator(self.data_path),steps_per_epoch=520,epochs=10,validation_data=validate_generator(self.validation_path),validation_steps=113,callbacks=[model_checkpoint])
